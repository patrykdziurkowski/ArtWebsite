...
[Migration("20250214163511_CreateReviewerWhenRegistering")]
partial class CreateReviewerWhenRegistering
{
        /// <inheritdoc />
                ...
                modelBuilder.Entity("web.Features.Artists.Artist", b =>
                    {
                            b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser<System.Guid>", null)
                    .WithOne()
                    .HasForeignKey("web.Features.Artists.Artist", "OwnerId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();
                    });
                ...
                modelBuilder.Entity("web.Features.Reviewers.Reviewer", b =>
                    {
                            b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser<System.Guid>", null)
                    .WithOne()
                    .HasForeignKey("web.Features.Reviewers.Reviewer", "OwnerId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();
                    });
